/* * G-Mesh Project
 * Versione: G-Talk Gen.1 for Heltec Meshtastic V3.2
 * (C) 2026 Semont Labs - www.semontlabs.com
 * (C) 2026 G-Mesh - www.g-mesh.org
 * (C) 2026 Emanuele Ferraro
 * License: General Public License V3 - See LICENSE file for further informations
 */
